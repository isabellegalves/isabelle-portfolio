  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "150px 48px 60px", width: "100%" }}>
        ...
        >
          <motion.svg
            width="240" height="70" viewBox="0 0 240 70"
            style={{ position: "absolute", top: -58, left: 0, overflow: "visible" }}
            aria-hidden="true"
            initial={{ opacity: 0 }}
...
function Capabilities() {
  const items = [
    ...
    { n: "02", title: "End-to-end, for real", body: "From research and discovery sessions to design systems and final handoff. I don't just deliver screens. I help shape the product from the question to the answer, working closely with POs, developers and stakeholders." },
      ...
      <div style={{ ...SHELL }}>
        <FadeUp>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 32, marginBottom: 52 }}>
            ...
            <motion.svg
              width="120" height="70" viewBox="0 0 120 70" overflow="visible" aria-hidden="true"
              initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
              transition={{ duration: 0.3 }}
            >
    ...
    <section id="contact" aria-labelledby="contact-heading" style={{ padding: "120px 48px", background: T.ink, textAlign: "center" }}>
      <FadeUp>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: 0 }}>
          <motion.svg
            width="130" height="56" viewBox="0 0 130 56" overflow="visible" aria-hidden="true"
            initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
            transition={{ duration: 0.3 }}
          >
            <motion.text x="0" y="22"
              style={{ fontFamily: "'Caveat', cursive", fontSize: "25px", fontWeight: 500, fill: "#ffffff" }}
              initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
              transition={{ delay: 0.1, duration: 0.4 }}
            >
              let's talk!
            </motion.text>
            <motion.path d="M 50 30 C 64 30, 78 34, 90 40"
              stroke="#ffffff" strokeWidth="1.5" fill="none" strokeLinecap="round"
              initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} viewport={{ once: true }}
              transition={{ delay: 0.5, duration: 0.6, ease: "easeOut" }}
            />
            <motion.path d="M 90 40 L 82 34"
              stroke="#ffffff" strokeWidth="1.5" fill="none" strokeLinecap="round"
              initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} viewport={{ once: true }}
              transition={{ delay: 1.1, duration: 0.2, ease: "easeOut" }}
            />
            <motion.path d="M 90 40 L 86 48"
              stroke="#ffffff" strokeWidth="1.5" fill="none" strokeLinecap="round"
              initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} viewport={{ once: true }}
              transition={{ delay: 1.3, duration: 0.2, ease: "easeOut" }}
            />
