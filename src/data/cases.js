export const cases = [
...

  {
    ...
    metrics: [
      { n: "150+", label: "Screens designed" },
      { n: "92%",  label: "Task completion (up from 71%)" },
      { n: "42%",  label: "Fewer steps to complete actions" },
      { n: "40+",  label: "New banking components" },
      { n: "23%",  label: "Engagement increase at launch" },
      { n: "20",   label: "User interviews conducted" },
    ],
    bg: "#EEF5EE",
    image: "/images/vr.png",
    overview: {
      ...
      context: "VR is one of Brazil's largest employee benefits companies, with 4.7 million users and 12 million monthly app sessions. When the decision was made to expand into full banking services, the challenge was not just technical. Users knew VR as their benefits app. Asking them to trust it as their bank required a completely different experience, one that felt secure, familiar and capable without losing the simplicity that made the original app successful.",
    },
    problem: {
      body: "VR had built a 30-year reputation as Brazil's leading meal and food voucher provider. When the decision was made to launch Banco VR as an integrated banking layer inside the existing super app, the design challenge was significant. Users trusted VR for benefits. Banking demanded a different level of trust, security and flow clarity. The existing app architecture was not built to support concurrent benefit and banking experiences without creating confusion.",
...

  {
    ...
    metrics: [
      { n: "11%", label: "Subscription conversion lift" },
      { n: "18%", label: "Abandonment reduction" },
      { n: "14%", label: "App download increase" },
      { n: "22%", label: "Fewer subscription complaints" },
      { n: "30+", label: "Conversion opportunities identified" },
    ],
    bg: "#EEF2F8",
    ...
    overview: {
      ...
      context: "O Globo and Valor Economico are two of Brazil's most influential news brands, operating under Editora Globo. Both rely heavily on digital subscriptions as a primary revenue stream, making the subscription journey a critical business asset.",
    },
    problem: {
