export const cases = [
...

  {
    ...
    overview: {
      ...
      context: "VR is one of Brazil's largest employee benefits companies, with 4.7 million users and 12 million monthly app sessions. When the decision was made to expand into full banking services, including money transfers, FGTS advance, private payroll loans and a digital account, the challenge was not just technical. Users knew VR as their benefits app. Asking them to trust it as their bank required a completely different experience, one that felt secure, familiar and capable without losing the simplicity that made the original app successful.",
    },
    problem: {
